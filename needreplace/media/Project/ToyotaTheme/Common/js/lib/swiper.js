        ...
        function Swiper() {
            ...
            Object.keys(swiper.modules).forEach(function (moduleName) {
                ...
                if (module.params) {
                    ...
                    if (
                        typeof params[moduleParamName] === 'object' && !('enabled' in params[moduleParamName])
                    ) {
                        params[moduleParamName].enabled = true;
                    }
    ...
    var Navigation$1 = {
        ...
        on: {
            ...
            click: function click(e) {
                ...
                var $prevEl = ref.$prevEl;
                if (
                    swiper.params.navigation.hideOnClick && !$(e.target).is($prevEl) && !$(e.target).is($nextEl)
                ) {
                    if ($nextEl) {
        ...
        on: {
            ...
            click: function click(e) {
                ...
                if (
                    ...
                    swiper.pagination.$el.length > 0 && !$(e.target).hasClass(swiper.params.pagination.bulletClass)
                ) {
