...
(function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        ...
        emptyResult: function () {
            ...
            noResults = $('<li class="bh-no-result"><div class="bh-sl-noresults-title">' + this.settings.noResultsTitle + '</div><br><div class="bh-sl-noresults-desc">' + this.settings.noResultsDesc + '</li>').hide().fadeIn();
        ...
        listClick: function (map, infowindow, storeStart, page) {
            ...
            $(document).on('click.' + pluginName, '.' + _this.settings.locationList + ' li', function () {
                ...
                if ($selectedLocation.length > 0) {
                    ...
                    // accordionStatus = localStorage.getItem('accordionStatus');
                    // accordionNo = localStorage.getItem('accordionNo');

                    // console.log('accordionStatus:', accordionStatus);
                    // console.log('accordion No:', accordionNo);
